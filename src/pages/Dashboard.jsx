            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input 
                  ...
                  className="w-full bg-[#101014] border border-white/10 rounded-xl py-2.5 px-4 text-sm text-white placeholder-gray-600 outline-none focus:border-accentNeon transition-colors"
                />
              </div>
